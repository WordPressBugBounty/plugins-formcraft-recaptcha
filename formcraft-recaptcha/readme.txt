...
= 1.9 =
Allow customizing the required score

= 1.8 =
Fixed 'missing captcha issue'

= 1.7 =
Fixed plugin priority issue

= 1.6 =
Fixed form disable issue

= 1.5 =
Remove v2, and replaced with v3. Please update your site keys.

= 1.4 =
Compatibility with FormCraft 3.5

= 1.3 =
* Fixed issue with plugin not working on sites which don't have allow_url_fopen enabled
